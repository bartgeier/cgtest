...
void test_joins_base_and_relative(void)
{
    char buf[256];
...
void test_avoids_double_slash_on_trailing_leading_slash(void)
{
    char buf[256];
...
void test_directory_rel_joins_same_as_file_rel(void)
{
...
void test_drops_dot_segments(void)
{
    char buf[256];
...
void test_dotdot_climbs_within_bounds(void)
{
    char buf[256];
...
void test_dotdot_in_base_and_rel_combine(void)
{
    char buf[256];
...
void test_excess_dotdot_clamps_at_root(void)
{
    char buf[256];
...
void test_empty_rel_yields_normalized_base(void)
{
    char buf[256];
...
void test_absolute_rel_discards_base(void)
{
    char buf[256];
...
void test_absolute_rel_is_still_normalized(void)
{
    char buf[256];
...
void test_backslashes_normalize_to_forward_slashes(void)
{
    char buf[256];
...
void test_windows_drive_absolute_rel_discards_base(void)
{
    char buf[256];
...
void test_mixed_separators_within_one_path(void)
{
    char buf[256];
    CPath p = cpath_join(buf, sizeof(buf), "/a", "b\\c/d");
...
void test_truncation_is_reported_and_null_terminated(void)
{
    char buf[8];
    CPath p = cpath_join(buf, sizeof(buf), "/home/user/project", "src/main.c");
...
void test_zero_capacity_is_safely_truncated(void)
{
    char buf[1];
...
void test_exact_fit_is_not_truncated(void)
{
    char buf[16];
    CPath p;
...
void test_dirname_of_top_level_entry_is_root(void)
{
    char buf[256];
...
void test_dirname_of_root_is_root(void)
{
    char buf[256];
...
void test_dirname_relative_with_separator(void)
{
    char buf[256];
